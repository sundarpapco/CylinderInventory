...
public class EditDestinationTransaction extends BaseTransaction {

    private Destination destination;

    public EditDestinationTransaction(@NonNull Destination destination){
    ...
    public Void apply(@NonNull Transaction transaction) throws FirebaseFirestoreException {
        ...
        if(!loadedDestination.isEditable())
            throw new FirebaseFirestoreException("This "+destination.getStringDestType() + " not editable anymore",
                    FirebaseFirestoreException.Code.CANCELLED);

        loadedDestination.setName(destination.getName());
        transaction.set(destinationRef,loadedDestination);
